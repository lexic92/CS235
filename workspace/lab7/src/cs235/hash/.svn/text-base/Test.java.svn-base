...
public class Test {
    ...
    public static void testIt9(Set s){
    	...
    	System.out.println("\n\nJust cleared the set and added the items "+
    			"in List A.  Expected order: \n");
    	System.out.println("[fungible, tautology, epiphany, bogus,\n"+
    			"enigma, fisticuffs, debacle, alabaster]\n\n"+
    			"MAKE SURE IT'S THE SAME AS THE FOLLOWING:");
   ...
   public static void mapPart3_2(Map m){
  ...
  public static void mapRemove5(Map m){
    ...
    public static void mapRemove6(Map m){
    	...
    	System.out.println("heresy: "+ (m.get("heresy").equals("cacophony") ? "PASSED" : "FAILED"));
    	System.out.println("bombastic: "+ (m.get("bombastic").equals("lollygag") ? "PASSED" :
    				"FAILED"));
    	System.out.println("sentient: "+ (m.get("sentient").equals("luscious") ?
    			"PASSED" : "FAILED"));
    	mapRemove6_2(m);
    }
    public static void mapRemove6_2(Map m){
    	System.out.println("blitzkrieg: "+ (m.get("blitzkrieg").equals("yurt") ? 
    			"PASSED" : "FAILED"));
    	System.out.println("infernal: "+ (m.get("infernal").equals("macabre") ? 
    			"PASSED" : "FAILED"));
    	System.out.println("euphoric: "+ (m.get("euphoric").equals("soporific") ?
    			"PASSED" : "FAILED"));
    	System.out.println("plethora: "+ (m.get("plethora").equals("ergo") ? "PASSED" : "FAILED"));
    	System.out.println("azure: "+ (m.get("azure").equals("pedantic") ? "PASSED" : "FAILED"));
    }
