...
class Model {
	...
	if (tree == null)
	    System.out.println("AVLGUI: An error occured. Please make sure " + 
			       "that TreeFactory.createTree() returns an object " +
	...
	if (t != null) {
	    s.push(t);
	    s.push(new TreeSet<String>(words));
	}
    }
...
class View extends JFrame {
	...
	private String getWord(TreeNode t) {
	...
	private int draw(Graphics g, TreeNode t, int x, int y) {
	...
	public void draw2(Graphics g, TreeNode t, int x, int y) {
